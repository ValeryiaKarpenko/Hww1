 ...
 * on 2017-10-18 at 18:19:03 UTC 
 * Modify at your own risk.
 */

package com.example.it.myapplication.backend.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends UserApiRequest<com.example.it.myapplication.backend.userApi.model.User> {
    ...
    protected Get(java.lang.Long id) {
      super(UserApi.this, "GET", REST_PATH, null, com.example.it.myapplication.backend.userApi.model.User.class);
   ...
   * @return the request
   */
  public Insert insert(java.lang.Integer age, java.lang.String male, java.lang.String name, java.lang.String surname) throws java.io.IOException {
    Insert result = new Insert(age, male, name, surname);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<com.example.it.myapplication.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Insert(java.lang.Integer age, java.lang.String male, java.lang.String name, java.lang.String surname) {
      super(UserApi.this, "POST", REST_PATH, null, com.example.it.myapplication.backend.userApi.model.User.class);
      this.age = com.google.api.client.util.Preconditions.checkNotNull(age, "Required parameter age must be specified.");
      this.male = com.google.api.client.util.Preconditions.checkNotNull(male, "Required parameter male must be specified.");
    ...
    public Insert setAge(java.lang.Integer age) {
      this.age = age;
      return this;
    }
    ...
    public Insert setMale(java.lang.String male) {
      this.male = male;
      return this;
    }
  ...
  public class List extends UserApiRequest<com.example.it.myapplication.backend.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, com.example.it.myapplication.backend.userApi.model.CollectionResponseUser.class);
    }
