...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.myapplication.IT.example.com",
                ownerName = "backend.myapplication.IT.example.com",
                packagePath = ""
        )
)
public class UserEndpoint {
    ...
    public User insert(@Named("name") String name, @Named("surname") String surname, @Named("male") String male,@Named("age") int age) {
        ...
        User user = new User(name, surname, male, age);
